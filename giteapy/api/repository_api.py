...
class RepositoryApi(object):
    ...
    def repo_add_collaborator(self, owner, repo, collaborator, **kwargs):  # noqa: E501
        """Add or Update a collaborator to a repository  # noqa: E501
    ...
    def repo_get_licenses(self, owner, repo, **kwargs):  # noqa: E501
        """Get repo licenses  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_get_licenses(owner, repo, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.repo_get_licenses_with_http_info(owner, repo, **kwargs)  # noqa: E501
        else:
            (data) = self.repo_get_licenses_with_http_info(owner, repo, **kwargs)  # noqa: E501
            return data

    def repo_get_licenses_with_http_info(self, owner, repo, **kwargs):  # noqa: E501
        """Get repo licenses  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_get_licenses_with_http_info(owner, repo, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method repo_get_licenses" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'owner' is set
        if self.api_client.client_side_validation and ('owner' not in params or
                                                       params['owner'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `owner` when calling `repo_get_licenses`")  # noqa: E501
        # verify the required parameter 'repo' is set
        if self.api_client.client_side_validation and ('repo' not in params or
                                                       params['repo'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `repo` when calling `repo_get_licenses`")  # noqa: E501
    ...
    def repo_get_raw_file(self, owner, repo, filepath, **kwargs):  # noqa: E501
        ...
        :param str owner: owner of the repo (required)
        :param str repo: name of the repo (required)
        :param str filepath: path of the file to get, it should be \"{ref}/{filepath}\". If there is no ref could be inferred, it will be treated as the default branch (required)
        :param str ref: The name of the commit/branch/tag. Default the repository’s default branch
        :return: file
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def repo_list_pull_requests_with_http_info(self, owner, repo, **kwargs):  # noqa: E501
        ...
        all_params = ['owner', 'repo', 'state', 'sort', 'milestone', 'labels', 'poster', 'page', 'limit']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('page' in params and params['page'] < 1):  # noqa: E501
            raise ValueError("Invalid value for parameter `page` when calling `repo_list_pull_requests`, must be a value greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and ('limit' in params and params['limit'] < 0):  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `repo_list_pull_requests`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
        ...
        if 'poster' in params:
            query_params.append(('poster', params['poster']))  # noqa: E501
        if 'page' in params:
            query_params.append(('page', params['page']))  # noqa: E501
        if 'limit' in params:
            query_params.append(('limit', params['limit']))  # noqa: E501
    ...
    def repo_merge_upstream(self, owner, repo, **kwargs):  # noqa: E501
        """Merge a branch from upstream  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_merge_upstream(owner, repo, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str owner: owner of the repo (required)
        :param str repo: name of the repo (required)
        :param MergeUpstreamRequest body:
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.repo_merge_upstream_with_http_info(owner, repo, **kwargs)  # noqa: E501
        else:
            (data) = self.repo_merge_upstream_with_http_info(owner, repo, **kwargs)  # noqa: E501
            return data

    def repo_merge_upstream_with_http_info(self, owner, repo, **kwargs):  # noqa: E501
        """Merge a branch from upstream  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_merge_upstream_with_http_info(owner, repo, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method repo_merge_upstream" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'owner' is set
        if self.api_client.client_side_validation and ('owner' not in params or
                                                       params['owner'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `owner` when calling `repo_merge_upstream`")  # noqa: E501
        # verify the required parameter 'repo' is set
        if self.api_client.client_side_validation and ('repo' not in params or
                                                       params['repo'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `repo` when calling `repo_merge_upstream`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='MergeUpstreamResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def repo_update_branch(self, owner, repo, branch, **kwargs):  # noqa: E501
        """Update a branch  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_update_branch(owner, repo, branch, async_req=True)
        >>> result = thread.get()
        ...
        :param UpdateBranchRepoOption body:
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.repo_update_branch_with_http_info(owner, repo, branch, **kwargs)  # noqa: E501
        else:
            (data) = self.repo_update_branch_with_http_info(owner, repo, branch, **kwargs)  # noqa: E501
            return data

    def repo_update_branch_with_http_info(self, owner, repo, branch, **kwargs):  # noqa: E501
        """Update a branch  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_update_branch_with_http_info(owner, repo, branch, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method repo_update_branch" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'owner' is set
        if self.api_client.client_side_validation and ('owner' not in params or
                                                       params['owner'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `owner` when calling `repo_update_branch`")  # noqa: E501
        # verify the required parameter 'repo' is set
        if self.api_client.client_side_validation and ('repo' not in params or
                                                       params['repo'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `repo` when calling `repo_update_branch`")  # noqa: E501
        # verify the required parameter 'branch' is set
        if self.api_client.client_side_validation and ('branch' not in params or
                                                       params['branch'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `branch` when calling `repo_update_branch`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/repos/{owner}/{repo}/branches/{branch}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def repo_update_branch_protection_priories(self, owner, repo, **kwargs):  # noqa: E501
        """Update the priorities of branch protections for a repository.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_update_branch_protection_priories(owner, repo, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str owner: owner of the repo (required)
        :param str repo: name of the repo (required)
        :param UpdateBranchProtectionPriories body:
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.repo_update_branch_protection_priories_with_http_info(owner, repo, **kwargs)  # noqa: E501
        else:
            (data) = self.repo_update_branch_protection_priories_with_http_info(owner, repo, **kwargs)  # noqa: E501
            return data

    def repo_update_branch_protection_priories_with_http_info(self, owner, repo, **kwargs):  # noqa: E501
        """Update the priorities of branch protections for a repository.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repo_update_branch_protection_priories_with_http_info(owner, repo, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method repo_update_branch_protection_priories" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'owner' is set
        if self.api_client.client_side_validation and ('owner' not in params or
                                                       params['owner'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `owner` when calling `repo_update_branch_protection_priories`")  # noqa: E501
        # verify the required parameter 'repo' is set
        if self.api_client.client_side_validation and ('repo' not in params or
                                                       params['repo'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `repo` when calling `repo_update_branch_protection_priories`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/repos/{owner}/{repo}/branch_protections/priority', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
