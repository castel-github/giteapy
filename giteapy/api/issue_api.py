...
class IssueApi(object):
    ...
    def issue_search_issues(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str state: State of the issue
        :param str labels: Comma-separated list of label names. Fetch only issues that have any of these labels. Non existent labels are discarded.
        :param str milestones: Comma-separated list of milestone names. Fetch only issues that have any of these milestones. Non existent milestones are discarded.
        :param str q: Search string
        :param int priority_repo_id: Repository ID to prioritize in the results
        :param str type: Filter by issue type
        :param datetime since: Only show issues updated after the given time (RFC 3339 format)
        :param datetime before: Only show issues updated before the given time (RFC 3339 format)
        :param bool assigned: Filter issues or pulls assigned to the authenticated user
        :param bool created: Filter issues or pulls created by the authenticated user
        :param bool mentioned: Filter issues or pulls mentioning the authenticated user
        :param bool review_requested: Filter pull requests where the authenticated user's review was requested
        :param bool reviewed: Filter pull requests reviewed by the authenticated user
        :param str owner: Filter by repository owner
        :param str team: Filter by team (requires organization owner parameter)
        :param int page: Page number of results to return (1-based)
    ...
    def issue_search_issues_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('page' in params and params['page'] < 1):  # noqa: E501
            raise ValueError("Invalid value for parameter `page` when calling `issue_search_issues`, must be a value greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and ('limit' in params and params['limit'] < 0):  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `issue_search_issues`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
