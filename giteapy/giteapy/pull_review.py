...
class PullReview(object):
    ...
    def __init__(self, body=None, comments_count=None, commit_id=None, dismissed=None, html_url=None, id=None, official=None, pull_request_url=None, stale=None, state=None, submitted_at=None, team=None, user=None, _configuration=None):  # noqa: E501
