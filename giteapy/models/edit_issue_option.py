...
class EditIssueOption(object):
    ...
    def __init__(self, assignee=None, assignees=None, body=None, due_date=None, milestone=None, ref=None, state=None, title=None, unset_due_date=None, _configuration=None):  # noqa: E501
