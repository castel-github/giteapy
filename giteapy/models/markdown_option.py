...
class MarkdownOption(object):
    ...
    def __init__(self, context=None, mode=None, text=None, wiki=None, _configuration=None):  # noqa: E501
    ...
    def mode(self):
        ...
        Mode to render (markdown, comment, wiki, file)  in: body  # noqa: E501
    ...
    def wiki(self):
        ...
        Is it a wiki page? (use mode=wiki instead)  Deprecated: true in: body  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MarkdownOption, dict):
